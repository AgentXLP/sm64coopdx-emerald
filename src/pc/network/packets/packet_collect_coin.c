...
SANITY_CHECK_COINS:;
    ...
    if (COURSE_IS_MAIN_COURSE(gCurrCourseNum) && oldNumCoins < gLevelValues.coinsRequiredForCoinStar && gMarioStates[0].numCoins >= gLevelValues.coinsRequiredForCoinStar && gCurrAreaIndex == areaIndex) {
